...
export const steps: {
...
}[] = [
  {
    ...
    content: <Step1 />,
    icon: <TypeIcon className="size-5 text-black sm:size-6" />,
  ...
  },
  {
    ...
    content: <Step3 />,
    icon: <Tag className="size-5 text-black sm:size-6" />,
  },
  {
    title: "Galeria",
    description:
    ...
    content: <Step4 />,
    icon: <Images className="size-5 text-black sm:size-6" />,
  },
  {
    title: "Miasto i cena",
    description:
    ...
    content: <Step5 />,
    icon: <Coins className="size-5 text-black sm:size-6" />,
  },
  {
    title: "Podsumowanie",
    description:
    ...
    content: <Result />,
    icon: <BadgeCheck className="size-5 text-black sm:size-6" />,
  },
];
