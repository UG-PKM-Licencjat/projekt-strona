...
export const Navbar = ({
  ...
  const isMobile = width ? width <= 640 : window.innerWidth <= 640;
  ...
  return (
    <>
      {!isMobile && (
        <nav className="sticky top-0 z-50 flex bg-neo-castleton">
      ...
      <div className="flex flex-1 flex-col overflow-auto">{children}</div>
      {isMobile && (
        <nav className="sticky bottom-0 z-50 flex w-full items-center justify-center transition-transform">
